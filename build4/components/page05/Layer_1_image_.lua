...
-- not
local imageWidth             = 660/4
local imageHeight            = 488/4
local mX, mY                 = _K.ultimatePosition(954, 687)
local oriAlpha = 1
--
local imagePath = "p5/layer_1.png"
--
...
local sheet    = graphics.newImageSheet ( _K.spriteDir.."page5.png", info:getSheet() )
