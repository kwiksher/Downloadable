...
-- not
local imageWidth             = 638/4
local imageHeight            = 284/4
local mX, mY                 = _K.ultimatePosition(1041, 663)
local oriAlpha = 1
--
local imagePath = "p6/layer_1.png"
--
function _M:localVars(UI)
    end
--
--[[
local info     = require ("assets.sprites.".."page6")
local sheet    = graphics.newImageSheet ( _K.spriteDir.."page6.png", info:getSheet() )
