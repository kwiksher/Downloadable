...
_Class.new = function(scene)
  ...
  function UI:setVars()
        ...
        self:_vars("image",  const.Epsode03Icon_image_, false)
        self:_vars("image",  const.Epsode02Icon_image_, false)
        self:_vars("image",  const.Epsode01Icon_image_, false)
  ...
  function UI:create()
    ...
    self:setLanguge()
        ...
        self:_create("image",  const.Epsode03Icon_image_, false)
        self:_create("image",  const.Epsode02Icon_image_, false)
        self:_create("image",  const.Epsode01Icon_image_, false)
  ...
  function UI:didShow(params)
    self:_didShow("common",  const.page_common, false)
        ...
        self:_didShow("image",  const.Epsode03Icon_image_, false)
        self:_didShow("image",  const.Epsode02Icon_image_, false)
        self:_didShow("image",  const.Epsode01Icon_image_, false)
  ...
  function UI:didHide(params)
    self:_didHide("common",  const.page_common, false)
        ...
        self:_didHide("image",  const.Epsode03Icon_image_, false)
        self:_didHide("image",  const.Epsode02Icon_image_, false)
        self:_didHide("image",  const.Epsode01Icon_image_, false)
  ...
  function UI:destroy(params)
    self:_destroy("common",  const.page_common)
        ...
        self:_destroy("image",  const.Epsode03Icon_image_, false)
        self:_destroy("image",  const.Epsode02Icon_image_, false)
        self:_destroy("image",  const.Epsode01Icon_image_, false)
  ...
  function UI:resume(params)
        ...
        self:_resume("image",  const.Epsode03Icon_image_, false)
        self:_resume("image",  const.Epsode02Icon_image_, false)
        self:_resume("image",  const.Epsode01Icon_image_, false)
