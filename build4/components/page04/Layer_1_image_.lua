...
-- not
local imageWidth             = 814/4
local imageHeight            = 508/4
local mX, mY                 = _K.ultimatePosition(946, 720)
local oriAlpha = 1
--
local imagePath = "p4/layer_1.png"
--
function _M:localVars(UI)
    end
--
--[[
local info     = require ("assets.sprites.".."page4")
local sheet    = graphics.newImageSheet ( _K.spriteDir.."page4.png", info:getSheet() )
