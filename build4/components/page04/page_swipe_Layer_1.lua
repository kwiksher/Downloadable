...
function _M:allListeners(UI)
  ...
  if layer.Layer_1 == nil then return end
  _K.Gesture.activate( layer.Layer_1, {swipeLength= pSpa }) --why
  _K.pageSwap = function (event )
    ...
    layer.Layer_1:addEventListener( _K.Gesture.SWIPE_EVENT, _K.pageSwap )
    end
--
function _M:toDispose(UI)
    local layer       = UI.layer
    layer.Layer_1:removeEventListener( _K.Gesture.SWIPE_EVENT, _K.pageSwap )
